      ...
      <div className="card bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
        <div className="flex items-start justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-2">Based on AI-powered analysis of your farming profile</p>
          </div>
    ...
    <div className={`card relative ${plan.recommended ? 'ring-2 ring-primary-500 shadow-xl' : ''}`}>
      {plan.recommended && (
        <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
          <span className="bg-primary-600 text-white px-4 py-1 rounded-full text-sm font-bold shadow-lg">
            Recommended
          </span>
        </div>
      )}
      ...
      <div className="mb-4">
        <p className="text-sm font-semibold text-gray-900 mb-2">Covered Crops:</p>
      ...
      {showDetails && (
        <div className="mb-4 border-t border-gray-200 pt-4">
          <p className="text-sm font-semibold text-gray-900 mb-2">Plan Benefits:</p>
